...
/* SVN FILE: $Id$ */
/**
 * Phamlp_Haml_Helpers class file.
 * 
 ...
 * 
 * Tthe path to the extended class is provided to Phamlp_Haml_Parser in the config
 * array; class name == file name.
 * 
 * Phamlp_Haml_Helpers and any extended class are automatically included in the context
...
class Phamlp_Haml_Helpers {
	 ...
	 * 
	 * Although handled in Phamlp_Haml_Parser, the notes below are here for completeness.<br/> 
