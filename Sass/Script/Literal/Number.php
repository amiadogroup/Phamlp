...
/* SVN FILE: $Id$ */
/**
 * Phamlp_Sass_Script_Literal_Number class file.
...
/**
 * Phamlp_Sass_Script_Literal_Number class.
 ...
 * @subpackage	Sass.script.literals
 */
class Phamlp_Sass_Script_Literal_Number extends Phamlp_Sass_Script_Literal {
	/**
   ...
   * pt: points — 1 point = 1/72nd of an inch
	 ...
	 * @param string number
	 * @return Phamlp_Sass_Script_Literal_Number
	 */
	 ...
	 * @param mixed Phamlp_Sass_Script_Literal_Number|Phamlp_Sass_Script_Literal_Colour: value to add
	 * @return mixed Phamlp_Sass_Script_Literal_Number if other is a Phamlp_Sass_Script_Literal_Number or
	 * Phamlp_Sass_Script_Literal_Colour if it is a Phamlp_Sass_Script_Literal_Colour
	 */
	public function op_plus($other) {
		if ($other instanceof Phamlp_Sass_Script_Literal_Colour) {
		...
		elseif (!$other instanceof Phamlp_Sass_Script_Literal_Number) {
			...
			return new Phamlp_Sass_Script_Literal_Number(($this->value + $other->value).$this->units);
		}
	}

	/**
	 * Unary + operator
	 * @return Phamlp_Sass_Script_Literal_Number the value of this number
	 */
	 ...
	 * @param mixed Phamlp_Sass_Script_Literal_Number|Phamlp_Sass_Script_Literal_Colour: value to subtract
	 * @return mixed Phamlp_Sass_Script_Literal_Number if other is a Phamlp_Sass_Script_Literal_Number or
	 * Phamlp_Sass_Script_Literal_Colour if it is a Phamlp_Sass_Script_Literal_Colour
	 */
	...
	/**
	 * Unary - operator
	 * @return Phamlp_Sass_Script_Literal_Number the negative value of this number
	 */
	public function op_unary_minus() {
		return new Phamlp_Sass_Script_Literal_Number(($this->value * -1).$this->units);
	}

	/**
	 * Multiplies this value by the value of other
	 * @param mixed Phamlp_Sass_Script_Literal_Number|Phamlp_Sass_Script_Literal_Colour: value to multiply by
	 * @return mixed Phamlp_Sass_Script_Literal_Number if other is a Phamlp_Sass_Script_Literal_Number or
	 * Phamlp_Sass_Script_Literal_Colour if it is a Phamlp_Sass_Script_Literal_Colour
	 */
	 ...
	 * @param mixed Phamlp_Sass_Script_Literal_Number|Phamlp_Sass_Script_Literal_Colour: value to divide by
	 * @return mixed Phamlp_Sass_Script_Literal_Number if other is a Phamlp_Sass_Script_Literal_Number or
	 * Phamlp_Sass_Script_Literal_Colour if it is a Phamlp_Sass_Script_Literal_Colour
	 */
	...
	public function op_eq($other) {
		if (!$other instanceof Phamlp_Sass_Script_Literal_Number) {
			return new Phamlp_Sass_Script_Literal_Boolean(false);
		}
		try {
	 ...
	 * @param Phamlp_Sass_Script_Literal_Number the other number
	 * @return Phamlp_Sass_Script_Literal_Number the other number with its value and units coerced if neccessary
	 * @throws Phamlp_Sass_Script_Literal_NumberException if the units are incompatible
	 */
	...
	public function coerce($numeratorUnits, $denominatorUnits) {
		return new Phamlp_Sass_Script_Literal_Number(($this->isUnitless() ?
				$this->value :
				$this->value *
	...
	private function coercionFactor($fromUnits, $toUnits) {
		...
		if (sizeof($fromUnits) !== sizeof($toUnits) || !$this->areConvertable(array_merge($fromUnits, $toUnits))) {
			throw new Phamlp_Sass_Script_Literal_NumberException("Incompatible units: '{from}' and '{to}'", array('{from}'=>join(' * ', $fromUnits), '{to}'=>join(' * ', $toUnits)), Phamlp_Sass_Script_Parser::$context->node);
		}
		...
		foreach ($fromUnits as $i=>$from) {
			if (array_key_exists($from) && array_key_exists($from)) {
				...
				throw new Phamlp_Sass_Script_Literal_NumberException("Incompatible units: '{from}' and '{to}",
	 ...
	 * Returns the integer value.
 	 ...
 	 * @throws Phamlp_Sass_Script_Literal_NumberException if the number is not an integer
	 */
	public function toInt() {
		if  (!$this->isInt()) {
			throw new Phamlp_Sass_Script_Literal_NumberException('Not an integer: {value}', array('{value}'=>$this->value), Phamlp_Sass_Script_Parser::$context->node);
		}
	...
	public function toString() {
		if  (!$this->hasLegalUnits()) {
			throw new Phamlp_Sass_Script_Literal_NumberException('Invalid {what}', array('{what}'=>"CSS units ({$this->units})"), Phamlp_Sass_Script_Parser::$context->node);
		}
