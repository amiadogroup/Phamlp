...
/* SVN FILE: $Id$ */
/**
 * Phamlp_Sass_Script_Literal_Colour class file.
...
/**
 * Phamlp_Sass_Script_Literal_Colour class.
 ...
 * representation – for example, Phamlp_Sass_Script_Literal_Colour::red for an HSL color – that
 * component is calculated and cached.
 * 
 * The alpha channel of a color is independent of its RGB or HSL representation.
 * It’s always stored, as 1 if nothing else is specified. If only the alpha
 * channel is modified using Phamlp_Sass_Script_Literal_Colour::with(), the cached RGB and HSL values
 * are retained.
 * 
 ...
 * @subpackage	Sass.script.literals
 */
class Phamlp_Sass_Script_Literal_Colour extends Phamlp_Sass_Script_Literal {
	/**@#+
	...
	*/
	 ...
	 * @return Phamlp_Sass_Script_Literal_Colour
	 */
	public function __construct($colour) {
		if (is_string($colour)) {
			...
			if ($colour === self::TRANSPARENT) {
				...
				if (empty($matches)) {
					throw new Phamlp_Sass_Script_Literal_ColourException('Invalid {what}', array('{what}'=>'Phamlp_Sass_Script_Literal_Colour string'), Phamlp_Sass_Script_Parser::$context->node);
				}
		...
		elseif (is_array($colour)) {
			...
			throw new Phamlp_Sass_Script_Literal_ColourException('{what} must be a {type}', array('{what}'=>'Colour', '{type}'=>'array'), Phamlp_Sass_Script_Parser::$context->node);
		}
	}
	
	/**
	 * Colour addition
	 * @param mixed Phamlp_Sass_Script_Literal_Colour|Phamlp_Sass_Script_Literal_Number value to add
	...
	public function op_plus($other) {
		...
		elseif (!$other instanceof Phamlp_Sass_Script_Literal_Colour) {
			throw new Phamlp_Sass_Script_Literal_ColourException('{what} must be a {type}', array('{what}'=>'Argument', '{type}'=>'Phamlp_Sass_Script_Literal_Colour or Phamlp_Sass_Script_Literal_Number'), Phamlp_Sass_Script_Parser::$context->node);
		}
		else {
	...
	/**
	 * Colour subraction
	 * @param mixed value (Phamlp_Sass_Script_Literal_Colour or Phamlp_Sass_Script_Literal_Number) to subtract
	 * @return sassColour the colour result
	 */
	 ...
	 * @param mixed Phamlp_Sass_Script_Literal_Colour|Phamlp_Sass_Script_Literal_Number value to multiply by
	 * @return sassColour the colour result
	 */
	...
	/**
	 * Colour division
	 * @param mixed value (Phamlp_Sass_Script_Literal_Colour or Phamlp_Sass_Script_Literal_Number) to divide by
	 * @return sassColour the colour result
	 */
	...
	/**
	 * Colour bitwise AND
	 * @param mixed value (Phamlp_Sass_Script_Literal_Colour or Phamlp_Sass_Script_Literal_Number) to bitwise AND with
	 * @return sassColour the colour result
	 */
	...
	/**
	 * Colour bitwise OR
	 * @param mixed value (Phamlp_Sass_Script_Literal_Colour or Phamlp_Sass_Script_Literal_Number) to bitwise OR with
	 * @return sassColour the colour result
	 */
	...
	/**
	 * Colour bitwise XOR
	 * @param mixed value (Phamlp_Sass_Script_Literal_Colour or Phamlp_Sass_Script_Literal_Number) to bitwise XOR with
	 * @return sassColour the colour result
	 */
	...
	*/
	public function with($attributes) {
		...
		return new Phamlp_Sass_Script_Literal_Colour($colour);
	} 
	...
	* @throws Phamlp_Sass_Script_Literal_ColourException if mixed colour space keys given or not all
	...
	private function assertValid($colour, $all = true) {
		if (array_key_exists('red', $colour) || array_key_exists('green', $colour) || array_key_exists('blue', $colour)) {
			if (array_key_exists('hue', $colour) || array_key_exists('saturation', $colour) || array_key_exists('lightness', $colour)) {
				throw new Phamlp_Sass_Script_Literal_ColourException('Phamlp_Sass_Script_Literal_Colour can not have HSL and RGB keys specified', array(), Phamlp_Sass_Script_Parser::$context->node);
			}
			if ($all && (!array_key_exists('red', $colour) || !array_key_exists('green', $colour) || !array_key_exists('blue', $colour))) {
				throw new Phamlp_Sass_Script_Literal_ColourException('Phamlp_Sass_Script_Literal_Colour must have all {colourSpace} keys specified', array('{colourSpace}'=>'RGB'), Phamlp_Sass_Script_Parser::$context->node);
			}
			return 'rgb';
		}
		elseif (array_key_exists('hue', $colour) || array_key_exists('saturation', $colour) || array_key_exists('lightness', $colour)) {
			if ($all && (!array_key_exists('hue', $colour) || !array_key_exists('saturation', $colour) || !array_key_exists('lightness', $colour))) {
				throw new Phamlp_Sass_Script_Literal_ColourException('Phamlp_Sass_Script_Literal_Colour must have all {colourSpace} keys specified', array('{colourSpace}'=>'HSL'), Phamlp_Sass_Script_Parser::$context->node);
			}
			return 'hsl';		
		}
		elseif ($all && sizeof($colour) < 3) {
				throw new Phamlp_Sass_Script_Literal_ColourException('Phamlp_Sass_Script_Literal_Colour array must have at least 3 elements', array(), Phamlp_Sass_Script_Parser::$context->node);
		}
	}
